...
class ManualIssueImporter:
    ...
    def import_prices(self) -> ManualIssueImportSummary:
        ...
        manual_rows = parsed.rows.copy()
        self._upsert_daily_manual_prices(manual_rows)
        cache_rows = parsed.to_cache_frame(manual_rows)
        if cache_rows.empty:
        ...
        report = build_cache_coverage_report(
            ...
            provider_by_ticker={
                ticker: "manual_upload" for ticker in parsed.tickers
            },
    ...
    def _print_summary(summary: ManualIssueImportSummary) -> None:
        ...
        print("Import mode: manual_upload")
