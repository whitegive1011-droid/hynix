...
class DecisionEngine:
    ...
    def _requires_uncertain_decision(self, data_quality: DecisionDataQuality) -> bool:
        return (
            ...
            or bool(data_quality.insufficient_history_tickers)
    ...
    def _uncertain_for_data_quality(
        ...
        if decision_input.data_quality.insufficient_history_tickers:
            reasons.append(
                "Insufficient manual history for 5D/Risk Score: "
                + ", ".join(decision_input.data_quality.insufficient_history_tickers)
